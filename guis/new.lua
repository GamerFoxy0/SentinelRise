...
local GradientAPI = (isfolder("sentinelrise") and isfile("sentinelrise/ColorAPI.lua")) and loadstring(readfile("sentinelrise/ColorAPI.lua"))() or loadstring(game:HttpGet("https://raw.githubusercontent.com/GamerFoxy0/SentinelRise/refs/heads/main/libraries/ColorAPI.lua"))()
local PublicConfigsGui = (isfolder("sentinelrise") and isfile("sentinelrise/Config.lua")) and loadstring(readfile("sentinelrise/Config.lua"))() or loadstring(game:HttpGet("https://raw.githubusercontent.com/GamerFoxy0/SentinelRise/refs/heads/main/libraries/Config.lua"))()
...
local getcustomassets = {
	...
	['sentinelrise/assets/new/new.png'] = 'rbxassetid://97775394291829'
}
...
function mainapi:CreateCategoryList(categorysettings)
	...
	if categorysettings.Name == "Profiles" then
		...
		newbutton.Image = getcustomasset('sentinelrise/assets/new/new.png')
		...
		publicButton.MouseButton1Click:Connect(function()
			if mainapi.gui.ScaledGui:FindFirstChild("ConfigGUI") then
				...
				PublicConfigsGui:Init(mainapi.gui.ScaledGui, notif, addvape,mainapi.GUIColor,"sentinelrise",SelectedProfile)
			end
		end)
	else
		local addbkg = Instance.new('Frame')
...
guipane:CreateButton({
	Name = 'Interface',
	Function = function()
		mainapi.gui.ScaledGui.LegitGUI.Visible = true
	end,
	Tooltip = 'This will reset your GUI back to default'
})
guipane:CreateButton({
...
VapeLogo.Name = 'Logo'
VapeLogo.Size = UDim2.fromOffset(120, 30)
VapeLogo.Position = UDim2.new(1, -123, 0, 105)
	...
	if textgui.Button.Enabled then
		...
		for i, v in mainapi.Modules do
			...
			if v.Enabled or table.find(found, i) then
				local holder = Instance.new('Frame')
				holder.Name = i
                holder.Position = UDim2.new(0, 3, 0, 84)
